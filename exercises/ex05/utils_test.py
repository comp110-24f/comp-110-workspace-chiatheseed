...
def test_only_evens_ret_list() -> None:
    """Tests that only_evens returns list[int] with even elements"""
...
def test_only_evens_edge() -> None:
    """Tests that only_evens returns empty list given empty list"""
    input_list: list[int] = []
...
def test_sub_ret_list() -> None:
    """Tests that subs returns a list[int] thats been modified based on given indexes"""
